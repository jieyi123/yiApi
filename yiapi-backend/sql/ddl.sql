...
(
    ...
    accessKey    varchar(255)                           null comment '签名认证accessKey',
    secretKey    varchar(255)                           null comment 'secretKey',
...
-- 接口信息表
create table if not exists yi_api.`interface_info`
(
...
-- 用户调用接口关系表
create table if not exists yi_api.`user_interface_info`
(
    id              bigint auto_increment comment '主键'
        primary key,
